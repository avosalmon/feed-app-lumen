...
use Kurashicom\Response\ResponseExceptionHandler;
	...
	public function registerClassBindings()
	{
		...
		$this->app->bind('Kurashicom\Response\ResponseHandler', function () {
			return new ResponseHandler(
				$this->app->make('Illuminate\Contracts\Routing\ResponseFactory'),
				array(), //successActions
				array($this->app->make('Kurashicom\Response\Actions\Logger')) //errorActions
			);
		});
	}
